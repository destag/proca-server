defmodule Proca.Server.KeysTest do
  ...
  test "I can get keys for encryption from server", %{red_org: o1, yellow_org: o2} do
    ...
    {o1_priv, o2_pub, _nonce1, key_ids} =
    ...
    {o1_priv, o2_pub, _nonce1, _k} = GenServer.call(p, {:encryption, [to: o2.id]})
    ...
    {o1_priv, o2_pub, _nonce1, _k} = GenServer.call(p, {:encryption, [from: o1.id, to: o2.id]})
    assert o1_priv == pk1.private
